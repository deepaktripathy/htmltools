...
document.write('<img border="0" width="1" height="1" src=' + tt_image_url +'>');
}
try{tt_image_write();} catch(theerr){ document.write('<img border="0" width="1" height="1" src="' + tt_image_url_err +'">');}
